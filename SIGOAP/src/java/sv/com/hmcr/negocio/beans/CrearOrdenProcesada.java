...
@ManagedBean
@ViewScoped
public class CrearOrdenProcesada implements java.io.Serializable {
    ...
    public void generar() {
        ...
        parametrosReportes.setEncabezado("HMCR SOLUTIONS\nREPORTE DE ORDENES PRO\nDEL PERIODO "+fecIni+" AL "+fecFin);
        dao.ejecutarProc("CALL Orden_Procesada('" + fecIni + "','" + fecFin + "')");
       try {
            FacesContext contex = FacesContext.getCurrentInstance();
            contex.getExternalContext().redirect("OrdenProcesada.xhtml");
        } catch (Exception e) {
        }
    }
